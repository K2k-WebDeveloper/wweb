...
<footer class="bg-[#1a5d47] dark:bg-[#1a5d47]">
      ...
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        ...
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
    <a href="#" class="hover:underline">Greengo</a>
</li>
                ...
                <li class="mb-4">
                    <a href="#" class="hover:underline">RAW</a>
                </li>

                <li class="mb-4">
                    <a href="#" class="hover:underline">Smoking</a>
                </li>
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-[#204b16] md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="#">Copyright Smart Shop Jordan.</a> All Rights Reserved
        </span>
